...
HRESULT CStage_Hexa::Initialize()
{
	CSoundMgr::Get_Instance()->StopAll();
	CSoundMgr::Get_Instance()->PlayBGM(L"BGM_Boss3.ogg");

	CObj* pObj = CAbstractFactory<CHexa>::Create();
...
void CStage_Hexa::Update()
{
	GET_INSTANCE(CObjMgr)->Update();
}

void CStage_Hexa::LateUpdate()
{
