...
HRESULT CStage_byrd::Initialize()
{
	CObj* pObj = CAbstractFactory<CByrd>::Create();
...
void CStage_byrd::Update()
{
	GET_INSTANCE(CObjMgr)->Update();
}

void CStage_byrd::LateUpdate()
{
